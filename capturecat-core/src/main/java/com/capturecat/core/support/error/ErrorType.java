...
public enum ErrorType {
	...
	INVALID_ACCESS_TOKEN(HttpStatus.BAD_REQUEST, ErrorCode.INVALID_ACCESS_TOKEN, LogLevel.WARN),
	INVALID_REFRESH_TOKEN(HttpStatus.BAD_REQUEST, ErrorCode.INVALID_REFRESH_TOKEN, LogLevel.WARN);
